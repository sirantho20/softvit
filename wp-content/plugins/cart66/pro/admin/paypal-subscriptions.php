...
<tbody>
  ...
  <tr>
    ...
    <td><?php echo CART66_CURRENCY_SYMBOL . $plan->setupFee; ?></td>
    ...
    <td>
      <a href='?page=cart66-paypal-subscriptions&task=edit&id=<?php echo $plan->id ?>'><?php _e( 'Edit' , 'cart66' ); ?></a> | 
      <a class='delete' href='?page=cart66-paypal-subscriptions&task=delete&id=<?php echo $plan->id ?>'><?php _e( 'Delete' , 'cart66' ); ?></a>
    </td>
  </tr>
  <?php endforeach; ?>
</tbody>
