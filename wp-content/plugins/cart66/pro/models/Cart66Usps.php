...
class Cart66Usps {
  ...
  public function getRates($zipOrigin, $zipDestination, $pounds=0, $ounces=0, $container='RECTANGULAR', $size='LARGE', $service='ALL', $machinable='true', $width=10, $length=15, $height=10) {
  ...
  public function getIntlRates($zipOrigin, $countryCode, $value, $pounds=0, $ounces=0, $commercial='N', $mailType='Package', $container='RECTANGULAR', $size="LARGE", $machinable='true', $width=10, $length=15, $height=10, $girth=0) {
